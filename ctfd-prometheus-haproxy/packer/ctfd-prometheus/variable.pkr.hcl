/*
 * CTFd Prometheus — Variable Declarations
 */
...
variable "machine1_ip" {
  type        = string
  description = "IP de Machine 1 récupérée après son build"
}

variable "machine2_ip" {
  type        = string
  description = "IP de Machine 2 récupérée après son build"
}