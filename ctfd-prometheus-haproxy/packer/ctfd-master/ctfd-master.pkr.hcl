source "proxmox-clone" "ctfd_master" {
...
build {
  sources = ["source.proxmox-clone.ctfd_master"]


  provisioner "ansible" {
    playbook_file = "../../ansible/machine1.yml"
  
    extra_arguments = [
      "--extra-vars", "ansible_ssh_pass=${var.ssh_password} ansible_become_pass=${var.ssh_password}",
      "--extra-vars", "ansible_remote_tmp=/home/bob/.ansible_tmp",
