# VM 213 — Brute Force Attack Medium
# Même logique que easy lab — script autoattack2.sh + timer systemd.

source "proxmox-clone" "wazuh-attack-medium" {
  ...
  vm_name              = "wazuh-attack-medium-{{timestamp}}"
  template_description = "Wazuh Attack Medium — Brute Force SSH automatisé"
...
build {
  name    = "wazuh-attack-medium"
  sources = ["source.proxmox-clone.wazuh-attack-medium"]
  ...
  post-processor "shell-local" {
    ...
    inline = [
      ...
      "echo '================================================='",
      "echo ' Wazuh Attack Medium - Build Complete! (VM 213)'",
      "echo '================================================='"
    ]
  }
}
