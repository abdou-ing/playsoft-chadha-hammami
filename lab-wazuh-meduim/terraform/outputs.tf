# ================================================================
# outputs.tf — Wazuh Medium Lab
# Remplace la génération manuelle du tf_output.json dans deploy.sh
# ================================================================
...
# deploy.sh fait : terraform output -json guacamole > tf_output.json
output "guacamole" {
